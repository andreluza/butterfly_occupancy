...
# Simulation study 2 - scenario 3 of partial overlap of covariates
...
dir.create(here ("figures", "sims_present_paper","Scenario3"))
...
# save
png(here("figures","sims_present_paper", "Scenario3", "Figure-3-st1-sc3.png"),
...
png(here("figures","sims_present_paper", "Scenario3", "Density_sigma2-st1-sc3.png"),
...
png(here("figures","sims_present_paper", "Scenario3", "Density_phi-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "Scenario3", "Density_sigma2_t-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "Scenario3", "Density_rho-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq
png(here("figures","sims_present_paper", "Scenario3", "biasVatT_sigma-sq-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# phi
png(here("figures","sims_present_paper", "Scenario3", "biasVatT_phi-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# rho
png(here("figures","sims_present_paper", "Scenario3", "biasVatT_rho-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq T
png(here("figures","sims_present_paper", "Scenario3", "biasVatT_sigma-sqT-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# arrange plot
png(here ("figures","sims_present_paper", "Scenario3", "panel_sp-st1-sc3.png"),
...
# plot 
png(here("figures","sims_present_paper", "Scenario3", "Figure-3-spatial-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "Scenario3", "Figure-3-temporal-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# save
png(here("figures","sims_present_paper", "Scenario3", "density.psi.p-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
#
#kaleido(plot_surface1, here("figures","sims_present_paper", "Scenario3", #"surface_sce1.png"))
#
#
...
# save
png(here("figures","sims_present_paper", "Scenario3", "density.psi.p.bars-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "Scenario3", "rel.beta0.beta1-st1-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
