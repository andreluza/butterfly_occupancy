...
# Simulation study 1: replication of D&S Simulations with higher spatial autocorrelation
...
dir.create(here("figures", "sims_D&S_smooth"))
...
# arrange plot
png(here("figures", "sims_D&S_smooth", "proj_Y_DS_smooth.png"),
...
# save
png(here("figures", "sims_D&S_smooth", "Figure-3-smooth.png"),
...
png(here("figures", "sims_D&S_smooth", "Density_sigma2-smooth.png"),
...
png(here("figures", "sims_D&S_smooth", "Density_phi-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)

dat.plot %>%
  filter (param == 2) %>%
  ggplot()+
  #geom_histogram(aes(x=val.theta,
  #                 group=scenario),fill="white")+
  geom_density(aes(x=val.theta,
                   group=scenario),fill="white")+
...
png(here("figures", "sims_D&S_smooth", "Density_sigma2_t-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures", "sims_D&S_smooth", "Density_rho-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq
png(here("figures", "sims_D&S_smooth", "biasVatT_sigma-sq-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# phi
png(here("figures", "sims_D&S_smooth", "biasVatT_phi-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# rho
png(here("figures", "sims_D&S_smooth", "biasVatT_rho-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq T
png(here("figures", "sims_D&S_smooth", "biasVatT_sigma-sqT-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# arrange plot
png(here ("figures", "sims_D&S_smooth", "panel_sp-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# plot 
png(here("figures", "sims_D&S_smooth", "Figure-3-spatial-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures", "sims_D&S_smooth", "Figure-3-temporal-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# save
png(here("figures", "sims_D&S_smooth", "density.psi.p-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# save
png(here("figures", "sims_D&S_smooth", "density.psi.p.bars-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures", "sims_D&S_smooth", "rel.beta0.beta1-smooth.png"),
    width = 20, height = 20, units = "cm", res=200)
