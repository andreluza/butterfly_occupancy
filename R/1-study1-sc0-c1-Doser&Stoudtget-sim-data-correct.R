...
dir.create(here ("model_output","output_simulations"))
dir.create(here ("model_output","output_simulations","sims_D&S" ))
...
# save
save(dat, file = here ("model_output", "output_simulations", "sims_D&S", "sim-data-correct.rda"))
