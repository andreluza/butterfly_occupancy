...
# using NNGP=15 to fit the models to data
...
dir.create(here ("figures", "TuningD&S_sims","ScenarioSpot2-NNGP-15"))

# Load the data sets
# load(file = here ("model_output", "output_simulations", "sims_D&S", "sim-data-correct.rda"))

# load model output
load(file = here ("model_output", "output_simulations", "scenario_phenology_spot_2_NNGP15",
...
# save
png(here("figures","TuningD&S_sims", "ScenarioSpot2-NNGP-15", "Figure-3-st3-sc3.png"),
...
png(here("figures","TuningD&S_sims", "ScenarioSpot2-NNGP-15", "Density_sigma2-st3-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","TuningD&S_sims", "ScenarioSpot2-NNGP-15", "Density_phi-st3-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","TuningD&S_sims", "ScenarioSpot2-NNGP-15", "Density_sigma2_t-st3-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","TuningD&S_sims", "ScenarioSpot2-NNGP-15", "Density_rho-st3-sc3.png"),
    width = 20, height = 20, units = "cm", res=200)
