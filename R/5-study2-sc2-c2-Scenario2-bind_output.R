...
#         (there were breaks  during the processing, so now I need to bind the results)
#                   
# -------------------------------------------------------
...
load(file = here ("model_output", "output_simulations", "scenario_two",
                  "sim-mixed-stPGOcc-results_108.rda"), envir = env1)
load(file = here ("model_output", "output_simulations", "scenario_two",
                  "sim-mixed-stPGOcc-results_1393.rda"), envir = env2)
load(file = here ("model_output", "output_simulations", "scenario_two",
                  "sim-mixed-stPGOcc-results_1600.rda"), envir = env3)
...
# save 
save.image(file = here ("model_output", "output_simulations", "scenario_two",
