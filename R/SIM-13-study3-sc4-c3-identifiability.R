...
# Produce output/figures used in the review responses (and SI E)
...
dir.create(here ("figures", "TuningD&S_sims","ScenarioSpotRev"))
...
# save
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "Figure-3-st3-sc2-rev.png"),
...
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "Density_sigma2-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "Density_phi-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "Density_sigma2_t-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "Density_rho-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "biasVatT_sigma-sq-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# phi
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "biasVatT_phi-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# rho
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "biasVatT_rho-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq T
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "biasVatT_sigma-sqT-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# arrange plot
png(here ("figures","TuningD&S_sims", "ScenarioSpotRev", "panel_sp-st3-sc2-rev.png"),
...
# plot 
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "Figure-3-spatial-st3-sc2-rev.png"),
...
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "Figure-3-temporal-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# save
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "density.psi.p-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
#
#kaleido(plot_surface1, here("figures","TuningD&S_sims", "ScenarioSpotRev", #"surface_sce1.png"))
#
#
...
# save
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "density.psi.p.bars-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","TuningD&S_sims", "ScenarioSpotRev", "rel.beta0.beta1-st3-sc2-rev.png"),
    width = 20, height = 20, units = "cm", res=200)
