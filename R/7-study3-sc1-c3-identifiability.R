...
# Simulation study 3 - 1 - scenario with phenology & observer preference for mid season
...
dir.create(here ("figures", "sims_present_paper","ScenarioPhenology"))
...
# save
png(here("figures","sims_present_paper", "ScenarioPhenology", "Figure-3-st3-sc1.png"),
...
png(here("figures","sims_present_paper", "ScenarioPhenology", "Density_sigma2-st3-sc1.png"),
...
png(here("figures","sims_present_paper", "ScenarioPhenology", "Density_phi-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "ScenarioPhenology", "Density_sigma2_t-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "ScenarioPhenology", "Density_rho-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq
png(here("figures","sims_present_paper", "ScenarioPhenology", "biasVatT_sigma-sq-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# phi
png(here("figures","sims_present_paper", "ScenarioPhenology", "biasVatT_phi-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# rho
png(here("figures","sims_present_paper", "ScenarioPhenology", "biasVatT_rho-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq T
png(here("figures","sims_present_paper", "ScenarioPhenology", "biasVatT_sigma-sqT-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# arrange plot
png(here ("figures","sims_present_paper", "ScenarioPhenology", "panel_sp-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# plot 
png(here("figures","sims_present_paper", "ScenarioPhenology", "Figure-3-spatial-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "ScenarioPhenology", "Figure-3-temporal-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# save
png(here("figures","sims_present_paper", "ScenarioPhenology", "density.psi.p-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
#
#kaleido(plot_surface1, here("figures","sims_present_paper", "ScenarioPhenology", #"surface_sce1.png"))
#
#
...
# save
png(here("figures","sims_present_paper", "ScenarioPhenology", "density.psi.p.bars-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "ScenarioPhenology", "rel.beta0.beta1-st3-sc1.png"),
    width = 20, height = 20, units = "cm", res=200)
