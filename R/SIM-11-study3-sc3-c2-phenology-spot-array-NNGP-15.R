...
# amount of data reestablished
# using NNGP=15 to fit the model to data
...
# SCENARIO 3 - SCENARIO 0 + SCENARIO 1 + SCENARIO 2 + SCENARIO 3 + phenology & observer preferences for mid season  & J=10 + spot (amount of data reestablished)
...
dir.create (here ("model_output", 
      "output_simulations", 
      "scenario_phenology_spot_2_NNGP15"))
...
# arrange plot
png(here("figures", "TuningD&S_sims", "scenario_phenology_spot_2_NNGP15.png"),
