...
dir.create(here ("figures", "sims_present_paper","ScenarioSpot"))
...
# load true psi 
# PS: During the simulations, I forgot to save `psi_true` along with the model results for scenarios 2-1 through 3-2. Consequently, I had to retrieve the true `psi_it` values in a later step—note that the random number generator seeds remained constant to avoid generating different data. Thus, I load this `psi_true` at this point in the code. The current code versions save `psi_true`, so the file "sim-mixed-stPGOcc-psi-true_1600.rda" will not be generated. Therefore, if you attempt to reproduce the results, the absence of this object is not an issue (the error can be ignored), as the true `psi_true` values are contained within the "sim-mixed-stPGOcc-results_1600.rda" object. If you encounter any problems, please get in touch (via email, GitHub issue, etc.).
load(file = here ("model_output", "output_simulations", "scenario_phenology_spot",
...
# save
png(here("figures","sims_present_paper", "ScenarioSpot", "Figure-3-st3-sc2.png"),
...
png(here("figures","sims_present_paper", "ScenarioSpot", "Density_sigma2-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "ScenarioSpot", "Density_phi-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "ScenarioSpot", "Density_sigma2_t-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "ScenarioSpot", "Density_rho-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq
png(here("figures","sims_present_paper", "ScenarioSpot", "biasVatT_sigma-sq-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# phi
png(here("figures","sims_present_paper", "ScenarioSpot", "biasVatT_phi-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# rho
png(here("figures","sims_present_paper", "ScenarioSpot", "biasVatT_rho-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# sigma sq T
png(here("figures","sims_present_paper", "ScenarioSpot", "biasVatT_sigma-sqT-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# arrange plot
png(here ("figures","sims_present_paper", "ScenarioSpot", "panel_sp-st3-sc2.png"),
...
# plot 
png(here("figures","sims_present_paper", "ScenarioSpot", "Figure-3-spatial-st3-sc2.png"),
...
png(here("figures","sims_present_paper", "ScenarioSpot", "Figure-3-temporal-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
# save
png(here("figures","sims_present_paper", "ScenarioSpot", "density.psi.p-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
#
#kaleido(plot_surface1, here("figures","sims_present_paper", "ScenarioSpot", #"surface_sce1.png"))
#
#
...
# save
png(here("figures","sims_present_paper", "ScenarioSpot", "density.psi.p.bars-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
...
png(here("figures","sims_present_paper", "ScenarioSpot", "rel.beta0.beta1-st3-sc2.png"),
    width = 20, height = 20, units = "cm", res=200)
