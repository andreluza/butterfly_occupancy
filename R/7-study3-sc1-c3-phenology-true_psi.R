...
#               Scenario phenology and observer preferences for mid season
...
# SCENARIO 3 - SCENARIO 0 + SCENARIO 1 + SCENARIO 2 + p in function of L_i  and V_itj
# SCENARIO phenology - SCENARIO 0 + SCENARIO 1 + SCENARIO 2 + SCENARIO 3 + phenology & J=10
...
for (s in 1:n.sims) {
  ...
  for (sc in 1:n.scenarios) {
    ...
    # remove three output files created before the present output
