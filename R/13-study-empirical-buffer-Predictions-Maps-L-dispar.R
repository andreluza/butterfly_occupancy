...
#     Modeling the distribution of L. dispar using data from 2000-2023
...
load (file=here ("model_output", 
                 "empirical",
                 paste0 ("buffer_outputNNG15_urban_", substr(sp_list[sp],1,12),".Rdata")),NG15weak)
...
png (here ("figures", "empirical","Fig_summ_results_Ldispar_buffer.png"),width = 27,height = 18,units = "cm",res=200)
