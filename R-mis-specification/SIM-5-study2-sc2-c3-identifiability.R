...
# load model output
load(file = here ("model_output_mis-specification", "output_simulations", "scenario_two",
...
# save
png(here("model_output_mis-specification","figures", "Figure-3-st2-sc2-probit.png"),
