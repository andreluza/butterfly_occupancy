...
dir.create(here ("model_output_mis-specification","output_simulations"))
dir.create(here ("model_output_mis-specification","output_simulations","sims_D&S" ))
...
for (j in 1:n.sims) {
  ...
  for (i in 1:n.scenarios) {
    ...
    dat[[(j - 1) * n.scenarios + i]] <- simTOcc(J.x = J.x, J.y = J.y, n.time = rep(n.time, J),
                                                ...
                                                mis.spec.type = "probit")
  }  
}

# save
save(dat, file = here ("model_output_mis-specification", "output_simulations", "sims_D&S", "sim-data-correct.rda"))
