...
# load model output
load(file = here ("model_output_mis-specification", "output_simulations", "scenario_phenology_spot_2",
...
# save
png(here("model_output_mis-specification","figures","Figure-3-st3-sc3-probit.png"),
