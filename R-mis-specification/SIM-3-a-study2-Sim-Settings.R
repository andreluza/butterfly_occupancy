...
# settings for simulations - applicable for studies 2 to 3
# on study 3 we only need to add one coefficient in alpha object (coefficients of the detection model)
...
dir.create(here ("model_output_mis-specification", "output_simulations","scenario_two")) # choosen for mis-specification study
...
# save
save.image(here("model_output_mis-specification", "output_simulations", "sim-settings.RData"))
